...
<div style="font-size:14px;font-family:'Montserrat';text-indent:20px;">
Another convenient way(used in stan.) to represent linear regression is to write the response as a normal random variable, with all the assumptions in the regression coefficients and noise being normal, which is exactly the compact representation in RStan:</div>
...
E(r) = 0; var(r) = $$\sigma^2$$
<div style="font-size:14px;font-family:'Montserrat';text-indent:20px;">
Again, in normal distribution representation, the above can be written as:</div>
...
<li>[biologyforfun](https://biologyforfun.wordpress.com/2016/11/10/hierarchical-models-with-rstan-part-1/)</li>

<li>[datascienceplus](https://datascienceplus.com/bayesian-regression-with-stan-part-1-normal-regression/)</li>

<li>[Stan_lectures](http://astrostatistics.psu.edu/su14/lectures/Daniel-Lee-Stan-2.pdf)</li>

<li>[The quantitative methods for Psychology](http://www.tqmp.org/RegularArticles/vol08-1/p052/p052.pdf)</li>
</ul>

...
<div style="font-size:14px;font-family:'Montserrat';text-indent:20px;">
The illustration of the hierarchical regression model starts with a normal linear regression:</div>
$$Y = \beta_0 + X\beta + r$$, <div style="font-size:14px;font-family:'Montserrat';text-indent:20px;">where X is the matrix design of the predictors.</div>
